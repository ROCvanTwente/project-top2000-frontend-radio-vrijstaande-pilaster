...
export default function Gestegen() {
    ...
    useEffect(() => {
        ...
        fetch(`https://localhost:7003/api/stats/stijgers?year=${year}`)
            .then(res => {
    ...
    return (
        <div style={{ backgroundColor: '#FEF3D4', minHeight: '90vh' }}>
            <div className="container py-5">
                ...
                {/* Song list */}
                {!loading && !error && rises.length > 0 && (
                    <div className="d-flex flex-column align-items-center gap-4">
                        {rises.map((song, index) => {
                                    ...
                                    <div className="d-flex flex-column flex-md-row align-items-center gap-3 gap-md-4">
                                        ...
                                        <div className="d-flex flex-row align-items-center gap-2 flex-shrink-0">
                                            ...
                                            >
                                                ...
                                                <div className="fw-bold py-2 text-white" style={{ backgroundColor: '#2e7d32' }}>
                                                    +{song.delta}
                                                </div>
                                            </div>
