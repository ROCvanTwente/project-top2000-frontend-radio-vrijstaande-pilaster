...
export default function Verdwenen() {
    ...
    useEffect(() => {
        apiFetch(`https://radio-vrijstaande-pilaster.runasp.net/api/stats/verdwenen?year=${year}`)
            .then(res => {
            ...
            <div className="container">
                ...
                <div className="mb-5 text-center">
                    ...
                    <small className="text-muted d-block mt-1">
                        Gesorteerd op positie in {prevYear}
                    </small>
                </div>
                ...
                {!loading && !error && songs.length === 0 && (
                    <p className="text-center">Geen verdwenen liedjes gevonden voor {year}</p>
                )}
                                ...
                                <div className="d-flex flex-column flex-md-row align-items-center gap-3 gap-md-4">
                                    <div className="d-flex flex-row align-items-center gap-2 flex-shrink-0">
                                        <div className="rounded-3 overflow-hidden border text-center" style={{ width: 72 }}>
                                            ...
                                            <div className="fw-bold py-2 text-white" style={{ backgroundColor: '#757575' }}>
                                                {prevYear}
                                            </div>
                                        </div>
